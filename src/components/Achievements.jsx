            ...
            return (
              <motion.div
                ...
                whileHover={{
                  y: -4,
                  boxShadow:
                    "0 0 32px color-mix(in srgb, var(--accent-color) 12%, transparent), 0 20px 48px -12px rgba(26,21,35,0.1)",
                }}
              >
                ...
                <div className="pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-accent/10 blur-2xl transition group-hover:bg-accent/15" />
                <div className="flex flex-1 flex-col gap-4 sm:flex-row sm:items-start">
                  <span className="relative flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-white/95 text-accent shadow-glowSoft">
